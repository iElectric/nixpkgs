...
self: super: {
  ...
  webkitgtk3 = super.webkitgtk3.override { webkit = pkgs.webkitgtk; };
  webkitgtk3-javascriptcore = super.webkitgtk3-javascriptcore.override { webkit = pkgs.webkitgtk; };
  websnap = super.websnap.override { webkit = pkgs.webkitgtk; };
